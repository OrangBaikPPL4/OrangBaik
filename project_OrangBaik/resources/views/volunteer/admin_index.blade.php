                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead>
                                <tr class="bg-gradient-to-r from-blue-600 to-blue-500">
                                    <th class="px-4 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Nama Acara</th>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150 ease-in-out">
                                    <td class="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900">{{ $volunteer->nama_acara }}</td>
                                    <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-700">{{ $volunteer->lokasi }}</td>
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-md text-sm font-medium {{ $volunteer->kuota_relawan > 0 && $volunteer->approved_participants_count >= $volunteer->kuota_relawan ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800' }}">
                                            {{ $volunteer->approved_participants_count }} / {{ $volunteer->kuota_relawan > 0 ? $volunteer->kuota_relawan : '∞' }}
                                        </span>
                                    </td>
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <div class="flex space-x-2">
                                            <a href="{{ route('volunteer.show', $volunteer->id) }}" class="inline-flex items-center px-2 py-1 bg-blue-100 text-blue-700 rounded-md text-sm hover:bg-blue-200">
                                            ...
                                            <a href="{{ route('volunteer.edit', $volunteer->id) }}" class="inline-flex items-center px-2 py-1 bg-green-100 text-green-700 rounded-md text-sm hover:bg-green-200">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
