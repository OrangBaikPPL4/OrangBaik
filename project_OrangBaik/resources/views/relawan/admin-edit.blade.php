                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <select name="status" id="status" class="w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                                    <option value="aktif" {{ old('status', $relawan->status) == 'aktif' ? 'selected' : '' }}>Aktif</option>
                                    <option value="bertugas" {{ old('status', $relawan->status) == 'bertugas' ? 'selected' : '' }}>Bertugas</option>
                                    <option value="selesai" {{ old('status', $relawan->status) == 'selesai' ? 'selected' : '' }}>Selesai</option>
                                </select>
                            </div>
                        </div>
