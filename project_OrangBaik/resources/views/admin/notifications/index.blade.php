<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Notifikasi Permintaan Bantuan') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-semibold">Notifikasi Permintaan Bantuan</h3>
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <p class="text-sm text-gray-500">
                                                    ...
                                                    @if($notification->request)
                                                        - <a href="{{ route('admin.request-bantuan.index') }}" class="text-blue-500 hover:underline">Lihat Permintaan</a>
                                                    @endif
                                                </p>
                                            </div>
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Anda akan menerima notifikasi saat ada permintaan bantuan baru.</p>
                        </div>
                    @endif
                </div>
            </div>
